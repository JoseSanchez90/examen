  ...
  if (subject === "verbal") {
    if (difficulty === "easy") {
      return [
        ...
        {
          question: "Completa la analogía: El perro es al hueso como el gato es al...",
          type: "multiple-choice",
        ...
        {
          question: "¿Qué palabra tiene el significado opuesto a 'generoso'?",
          type: "multiple-choice",
          options: ["Amable", "Egoísta", "Bondadoso", "Caritativo"],
          correctAnswer: "b",
        },
        {
      ...
      return [
        ...
        // Preguntas adicionales más difíciles
        {
          question: "¿Cuál es el significado de 'ambiguo'?",
          type: "multiple-choice",
          options: ["Claro", "Que tiene varios significados", "Preciso", "Exacto"],
          correctAnswer: "b",
        },
        {
      ...
      return [
        ...
        // Preguntas adicionales más difíciles
        {
          question: "¿Cuál es el significado de 'ominoso'?",
          type: "multiple-choice",
          options: ["Favorable", "Amenazador", "Brillante", "Esperanzador"],
          correctAnswer: "b",
        },
        {
          question: "¿Qué figura literaria se utiliza en 'Las perlas de tu boca'?",
          type: "multiple-choice",
          options: ["Símil", "Metáfora", "Hipérbole", "Onomatopeya"],
          correctAnswer: "b",
        },
      ]
    }
